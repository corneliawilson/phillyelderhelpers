...
import VolunteerRegistration from './views/Pages/Register/VolunteerRegistration';
...
const routes = [
  ...
  { path: '/register/volunteer', exact: true, name: 'Error', component: VolunteerRegistration},
